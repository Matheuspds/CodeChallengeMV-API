...
public class ResponseAPIUtil {
	...
	public ResponseAPI getDefaultBusinessExceptionResponse(BusinessException e) {
		return mountResponse(Boolean.FALSE, Arrays.asList(new MessageAPI(e.getMessage(), SeverityEnum.ERROR)));
	}

	public ResponseAPI getDefaultExceptionResponse(Exception e) {
		if (e instanceof BusinessException) {
			return getDefaultBusinessExceptionResponse((BusinessException) e);
		}
